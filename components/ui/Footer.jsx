        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">Kelvin Ndoma</span>
            </div>
            <p className="text-gray-300 text-sm leading-6">
              Professional web development, digital marketing, and tech consultation services. 
              ...
              <dl className="mt-6 space-y-4">
                <div className="flex gap-x-4">
                  ...
                  <dd className="text-sm leading-6 text-gray-300">
                    <a href="mailto:hello@kelvinndoma.com">hello@kelvinndoma.com</a>
                  </dd>
                </div>
                <div className="flex gap-x-4">
                  <dt className="flex-none">
